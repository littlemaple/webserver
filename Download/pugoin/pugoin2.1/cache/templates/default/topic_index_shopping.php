...
<link href="templates/default/styles/square.css" rel="stylesheet" type="text/css" />
<div id="vg_center">

	<!--Shopping列表 Begin--><div class="top_tags">
...
<?php } } ?>
	...
	<div class="list_wrap">
    	...
    	<div class="list_title">
            <h3 class="fl title_bg">
                新人推荐
            </h3>
            <span class="fr">
			<a href="javascript:viod(0);" onclick="recommend_user_show_ajax(); return false;">换一换</a>
			</span>
        </div>
		<div id="recommend_user_area" class="list_content">
		<!--新人推荐列表 Begin-->
    ...
    <div class="list_wrap">
        ...
        <!--Shopping列表 Begin--> <div class="vg_connbody">
