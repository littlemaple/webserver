...
<script type="text/javascript" src="templates/default/js/iColorPicker.js"></script>
<script>
...
<div class="main_2b">
<div class="main_t"><span>微博秀</span></div>
...
<?php if(!is_array($val)) { ?>
	<li><div <?php echo $_hoverCLS; ?>><A HREF="index.php?mod=tools&code=<?php echo $key; ?>"><span><?php echo $val; ?></span></A></div></li>
...
<input type="hidden" name="FORMHASH" value='<?php echo FORMHASH; ?>'/>
		...
		<li><h4>设置尺寸：</h4></li>
		<ul>
			<span>宽：<input name="width" type="text"  value="<?php echo $width; ?>"  size="3" onchange="TopicShowSubmit();"/>
			px</span> 
			<span style="margin-left:20px;">高：<input name="height" type="text"  value="<?php echo $height; ?>"size="3" onchange="TopicShowSubmit();"/>px</span>	
		</ul>
		
	
		<li><h4>颜色设置:</h4></li>	
		<ul>
			<li>标题色：<input id="titleColor" 	name="titleColor" value="<?php echo $titleColor; ?>" type="text" class="iColorPicker"  style="width:70px;"/></li>
			<li>背景色：<input id="bgColor" 	name="bgColor" 	  value="<?php echo $bgColor; ?>" 	type="text" class="iColorPicker"  style="width:70px;"></li>
		
			<li>主字色：<input id="textColor" name="textColor" value="<?php echo $textColor; ?>" type="text" class="iColorPicker"  style="width:70px;" ></li>
			<li>链接色：<input id="linkColor" name="linkColor" value="<?php echo $linkColor; ?>" type="text" class="iColorPicker"  style="width:70px;" /></li>
			<li>边框色：<input id="borderColor" name="borderColor" value="<?php echo $borderColor; ?>" type="text" class="iColorPicker"  style="width:70px;" /></li>
		...
		<ul style="float:left; width:110px;">
			<li><input type="checkbox" id="isTitleCheckbox" name="isTitle"  value="1" 
<?php if($isTitle) echo "checked=checked"; ?>
  onclick="TopicShowSubmit();"/><label for="isTitleCheckbox">显示标题</label></li>
			<li><input type="checkbox" id="isBorderCheckbox" name="isBorder" value="1" 
<?php if($isBorder) echo "checked=checked"; ?>
  onclick="TopicShowSubmit();"/><label for="isBorderCheckbox">显示边框</label></li>
		</ul>
		<ul>
			<li><input type="checkbox" id="isTopicCheckbox" name="isTopic" value="1" 
<?php if($isTopic) echo "checked=checked"; ?>
  onclick="TopicShowSubmit();"/><label for="isTopicCheckbox">显示微博</label></li>
			<li><input type="checkbox" id="isFansCheckbox" name="isFans"   value="1" 
<?php if($isFans) echo "checked=checked"; ?>
  onclick="TopicShowSubmit();"/><label for="isFansCheckbox">显示粉丝</label></li>
		</ul>
		...
		<ul>
			<li>
			显示：<input name="showFans" id="showFans" size="2" maxlength="2"  value="<?php echo $showFans; ?>"  onchange="TopicShowSubmit();" />
			行</li>
		...
		<ul>
			<li><textarea name="textarea" cols="30" rows="5" id="txtTestCode" class="textStyle"><iframe id="iframeid" width="<?php echo $width; ?>" height="<?php echo $height; ?>" name="ifrmname" frameborder="0" scrolling="No" src="<?php echo $this->Config['site_url']; ?>/index.php?mod=show&uid=<?php echo MEMBER_ID; ?>&width=<?php echo $width; ?>&height=<?php echo $height; ?>&color=<?php echo $iframe_color; ?>&showFans=<?php echo $showFans; ?>&isFans=<?php echo $isFans; ?>&isTopic=<?php echo $isTopic; ?>&isTitle=<?php echo $isTitle; ?>&isBorder=<?php echo $isBorder; ?>"></iframe></textarea>
			</li>
 ...
 <div class="showBox_r"><iframe id="iframeid" width="<?php echo $width; ?>" height="<?php echo $height; ?>" name="ifrmname" frameborder="0" scrolling="No" src="<?php echo $this->Config['site_url']; ?>/index.php?mod=show&uid=<?php echo MEMBER_ID; ?>&width=<?php echo $width; ?>&height=<?php echo $height; ?>&color=<?php echo $iframe_color; ?>&showFans=<?php echo $showFans; ?>&isFans=<?php echo $isFans; ?>&isTopic=<?php echo $isTopic; ?>&isTitle=<?php echo $isTitle; ?>&isBorder=<?php echo $isBorder; ?>"></iframe></div>
 
 
 </div>   </div>
</div></div><script type="text/javascript" src="templates/default/js/combobox.js"></script>
