...
class TemplateHandler
{
	...
	function TemplateHandler(&$config)
	{
        ...
        $this->TemplateHeadAdd = '<?php /'.'* '.date('Y-m-d').' in pugo.in invalid request template *'.'/ if(!defined("IN_PUGOIN")) exit("invalid request"); ?>';
	}
    ...
    function MakeDir($dir_name, $mode = 0777)
    {
        ...
        return $IoHandler->MakeDir($dir_name, $mode);        
    }
