 ...
 *
 * @Date 2011-09-16 17:25:33 1222553354 1676102110 37600 $
 *******************************************************************/
	...
	function chk_qun_post(&$struct_qun)
	{
		...
		if (empty($struct_name) || strlen($struct_name) < 3) {
			return -1;
				...
				$cat_ary = ConfigHandler::get('qun_category');
		if (empty($struct_qun['sub_cat']) || empty($cat_ary['second'][$struct_qun['sub_cat']])) {
			return -2;
		}
