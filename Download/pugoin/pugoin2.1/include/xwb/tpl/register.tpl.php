...
<div id="regBox" class="xwb-plugin-form" style="display:block;">
    ...
    <?php if($GLOBALS['jsg_sys_config'][invite_enable] && !$GLOBALS['jsg_sys_config'][invite_by_admin]) { ?>
       ...
       非常抱歉，本站目前需要有邀请链接才能注册,请加QQ：2432241898，或发送邮到到：2432241898@qq.com；<a href="javascript:void(function(){})" class="xwb-plugin-td-right-a" onclick="forTurn('bind')" tabindex="-1"><span><strong>请点此绑定已有的帐号</strong></span></a>
