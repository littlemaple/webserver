...
function usertheme(obj) {
    ...
    $("a").css("color",ele[2]);
     ...
     var mybgSET=$("#mybgimage").attr("src"); 
        ...
        setpic();
        $("#setbgyes").css("backgroundImage","url("+thisSiteURL+"templates/default/images/theme/"+ele[3]+"/themebg_preview.jpg)");
        $("#user-background-"+ele[4]).attr("checked",true);
        if (ele[4]=="repeat") {
            $("body").css("background",ele[0]+" url("+thisSiteURL+"templates/default/images/theme/"+ele[3]+"/themebg.jpg) repeat scroll left top");
        } else if (ele[4]=="center"){
            $("body").css("background",ele[0]+" url("+thisSiteURL+"templates/default/images/theme/"+ele[3]+"/themebg.jpg) no-repeat scroll center top");
        } else if (ele[4]=="left"){
            $("body").css("background",ele[0]+" url("+thisSiteURL+"templates/default/images/theme/"+ele[3]+"/themebg.jpg) no-repeat scroll left top");
        }
