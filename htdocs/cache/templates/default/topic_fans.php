...
<?php if(!$pageOnOff) { ?>
 -->
当前<?php echo $member['fans_count']; ?>人在关注<?php echo $member['nickname']; ?> 
<?php if(MEMBER_ID) { ?>
...
<!--粉丝筛选 Begin-->
<div class="nfBox" style="margin-left:15px; margin-right:15px;">
  <div class="left">排序方式：
...
<?php } else { ?>
<?php if($this->Config['topic_level_radio']) { ?>
			<span class="wb_l_level"><a href="index.php?mod=settings&code=exp" target="_blank" class="ico_level wbL<?php echo $val['level']; ?>"><em><?php echo $val['level']; ?></em></a></span>
...
<?php } ?>
		 ...
		 <span>
			...
			<span id="remarklist_<?php echo $val['uid']; ?>">
<?php if($val['remark']) { ?>
(<?php echo $val['remark']; ?>)
<?php } ?>
</span></a>
		...
		<p><span>粉丝<?php echo $val['fans_count']; ?>人 | <?php echo $val['topic_count']; ?>条分享</span></p>
