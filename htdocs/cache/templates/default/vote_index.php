...
<div class="main3Box_m HotW ">
  <div id="topNews_1" class="Hotwarp">
    <div class="Menubox2" style=" width:556px;">
    <ul>
    <li><div  class="
<?php if($active['hot']) { ?>
tago
<?php } else { ?>tagn
<?php } ?>
" > <A HREF="index.php?mod=vote&view=hot"><span>热门投票</span></A> </div></li>
    <li><div class="
<?php if($active['new']) { ?>
tago
<?php } else { ?>tagn
<?php } ?>
"> <A HREF="index.php?mod=vote&view=new"><span>最新投票</span></A> </div></li>
...
<?php } else { ?>tagn
<?php } ?>
"> <A HREF="index.php?mod=vote&view=me"><span>我的投票</span></A> </div></li>
    <li><div class="
<?php if($active['fllow']) { ?>
tago
<?php } else { ?>tagn
<?php } ?>
"> <A HREF="index.php?mod=vote&view=fllow"><span>我关注的人的投票</span></A> </div></li>
    
<?php } ?>
    </ul>
    </div>
    <style type="text/css">
	a.v_on{ color:#fff; font-weight:700; background:#056EA1; padding:3px;}
</style>
...
<?php if(!empty($filter)) { ?>
	  	<div style="margin-left:15px; margin-right:15px; margin-bottom:10px; margin-top:10px;" id="vote_filter_wp">
<?php if($view=='hot') { ?>
				<a href="index.php?mod=vote&view=hot&filter=t" <?php echo $filter_on['t']; ?> >24小时</a>
				<span style="color:#CCCCCC; margin-right:5px; margin-left:5px;">|</span>
				<a href="index.php?mod=vote&view=hot&filter=w" <?php echo $filter_on['w']; ?> >7天</a>
				<span style="color:#CCCCCC; margin-right:5px; margin-left:5px;">|</span>
				<a href="index.php?mod=vote&view=hot&filter=m" <?php echo $filter_on['m']; ?> >30天</a><?php } elseif($view=='me') { ?><a href="index.php?mod=vote&view=me&filter=created&uid=<?php echo $uid; ?>" <?php echo $filter_on['created']; ?> >我发起的投票</a>
				<span style="color:#CCCCCC; margin-right:5px; margin-left:5px;">|</span>
				<a href="index.php?mod=vote&view=me&filter=joined&uid=<?php echo $uid; ?>" <?php echo $filter_on['joined']; ?> >我参与的投票</a>
				<span style="color:#CCCCCC; margin-right:5px; margin-left:5px;">|</span>
				<a href="index.php?mod=vote&view=me&filter=new_update&uid=<?php echo $uid; ?>" <?php echo $filter_on['new_update']; ?> >最近更新的投票</a><?php } elseif($view=='fllow') { ?><a href="index.php?mod=vote&view=fllow&filter=created" <?php echo $filter_on['created']; ?> >他们发起的投票</a>
				<span style="color:#CCCCCC; margin-right:5px; margin-left:5px;">|</span>
				<a href="index.php?mod=vote&view=fllow&filter=joined" <?php echo $filter_on['joined']; ?> >他们参与的投票</a>
...
<?php } else { ?>        <div style="margin-left:5px;">还没有投票。</div>
...
<?php if($this->Config['ad_enable']) { ?>
<div align="center" class="T_AD"> <?php echo $this->Config['ad']['ad_list']['vote']['footer']; ?> </div>
<?php } ?>
