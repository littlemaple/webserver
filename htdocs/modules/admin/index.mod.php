...
class ModuleObject extends MasterObject
{
	...
	function _recommendList() {
		return array (
		  'overtime' => time() + 86400,
          'string' => '<li class="liS"><a href="http:/'.'/www.dream3.cn/pugoin" target="_blank"><font color=red>蒲公英V2.1.0beta版已经上线公测了</font></a></li><li class="liS"><a href="admin.php?mod=index&code=help&new=1&action_name=新手上路向导" target="_blank"><font color=blue>【重要】初次使用蒲公英，请看新手上路向导！</font></a></li>'
		);
	}
